...
public class Bus : HeavyVehicle
{
    ...
    public Bus(int id, byte numberOfSeats, byte numberOfSleepingSpaces, bool hasToilet, HeavyVehicle heavyVehicle) :
        base(heavyVehicle.HeavyVehicleId, heavyVehicle.Dimensions, heavyVehicle)
    {
        BusId = id;
